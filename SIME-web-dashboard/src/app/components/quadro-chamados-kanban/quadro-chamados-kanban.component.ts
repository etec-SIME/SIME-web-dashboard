...
@Component({
  selector: 'app-quadro-chamados-kanban',
  imports: [ChamadoCardComponent, RouterModule, CdkDropListGroup, CdkDropList, CdkDrag],
  templateUrl: './quadro-chamados-kanban.component.html',
  styleUrl: './quadro-chamados-kanban.component.css'
})
export class QuadroChamadosKanbanComponent {
