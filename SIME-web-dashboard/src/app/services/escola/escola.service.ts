...
export class EscolaService {
  ...
  private apiUrl = 'http://localhost:8081/escolas';

  constructor(private http: HttpClient) { }

  token : String = 'eyJhbGciOiJIUzI1NiJ9..KIhcUX6QiU__HD6VxLyYyHxqYLgfs9VJ6MVecm6Bawc';
